                    ...
                    @foreach ($sql as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a style="top: 0" href="{{ route('usuario.edit', $item->id_cliente) }}"
                                    class="btn btn-sm btn-warning m-1"><i class="fas fa-edit"></i></a>
                                <form action="{{ route('usuario.destroy', $item->id_cliente) }}" method="post"
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group mb-1 col-12">
                                                <form action="{{ route('usuario.actualizarImagen') }}"
                                                    ...
                                                    <input type="hidden" name="nomFoto" value="{{ $item->foto }}">
